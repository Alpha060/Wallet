...
$depId = null;
if ($user) {
    $ins = $pdo->prepare("INSERT INTO deposit_requests (user_id,amount,payment_proof_url,transaction_id,status) VALUES (:u,5000,'/uploads/diag.png','DIAGTX','pending') RETURNING id");
    $ins->execute(['u' => $user['id']]);
    $depId = $ins->fetchColumn();
