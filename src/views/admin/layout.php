<?php
// src/views/admin/layout.php - Shared shell layout for all administrator views
initSession();
$user = requireAdmin();
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px; padding: 4px;">
                ...
                <h2 style="font-weight: 800; font-size: 1.3rem; letter-spacing: -0.02em;">Admin<span style="color: var(--primary);">Pay</span></h2>
            </div>
            ...
            <div class="glass-card" style="padding: 16px; margin-bottom: 10px; display: flex; align-items: center; gap: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
                ...
                <div>
                    <div style="font-size: 0.85rem; font-weight: 700; color: var(--foreground);"><?= htmlspecialchars($user['name'] ?: 'Admin'); ?></div>
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div style="position: relative;" class="profile-dropdown-container">
                    <button id="profile-dropdown-trigger-mobile" style="background: none; border: none; cursor: pointer; display: flex; align-items: center; padding: 4px;">
                        <div style="width: 32px; height: 32px; border-radius: 50%; background: var(--primary-glow); color: var(--primary); display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.85rem; border: 1px solid var(--border);">A</div>
                    </button>
                ...
                <div style="display: flex; align-items: center; gap: 16px;">
                    ...
                    <div style="position: relative;" class="profile-dropdown-container">
                        <button id="profile-dropdown-trigger" style="background: none; border: none; cursor: pointer; display: flex; align-items: center; padding: 4px;">
                            <div style="width: 38px; height: 38px; border-radius: 50%; background: var(--primary-glow); color: var(--primary); display: flex; align-items: center; justify-content: center; font-weight: 700; border: 1px solid var(--border);">A</div>
                        </button>
                        <!-- Dropdown options -->
    ...
    <div class="modal-overlay" id="change-password-modal">
        <div class="modal-content" style="max-width: 440px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <h3 style="font-weight: 800; color: var(--foreground); margin: 0;">Change Password</h3>
            ...
            <form id="change-password-form">
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input class="form-input" type="password" id="cp-current" required placeholder="Enter current password">
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input class="form-input" type="password" id="cp-new" required placeholder="Enter new password" minlength="6">
                        <button type="button" class="password-toggle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0z"/><circle cx="12" cy="12" r="3"/></svg>
                        </button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        <input class="form-input" type="password" id="cp-confirm" required placeholder="Re-enter new password">
                        <button type="button" class="password-toggle">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0z"/><circle cx="12" cy="12" r="3"/></svg>
                        </button>
                    </div>
                ...
                <div style="display: flex; gap: 12px; margin-top: 28px;">
                    <button type="button" class="btn-secondary" onclick="closeChangePasswordModal()" style="flex: 1; padding: 12px 20px;">Cancel</button>
                    <button type="submit" class="btn-primary" id="cp-submit-btn" style="flex: 1; padding: 12px 20px; color: #000000; font-weight: 700;">Update Password</button>
                </div>
            </form>
        </div>
    </div>
