...
$title = "AeroPay - Overview";
$description = "Your AeroPay balance and transaction highlights";
...
<div style="background: var(--card); border: 1px solid var(--border); border-radius: 24px; padding: 32px; margin-bottom: 32px; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.1); position: relative; overflow: hidden; max-width: 500px;">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; position: relative; z-index: 1;">
        <div>
            <div style="color: var(--muted); font-size: 0.8rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px;">AeroPay Card</div>
    ...
    <div style="display: flex; gap: 12px; margin-top: 32px; position: relative; z-index: 1;">
        <a href="/deposit" class="btn-primary" style="flex: 1; text-align: center; text-decoration: none;">📥 Deposit</a>
        <a href="/withdraw" class="btn-secondary" style="flex: 1; text-align: center; text-decoration: none;">📤 Withdraw</a>
    </div>
</div>
